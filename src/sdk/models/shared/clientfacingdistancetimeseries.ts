 ...
 */
export enum ClientFacingDistanceTimeseriesUnit {
    M = "m",
}

export class ClientFacingDistanceTimeseries extends SpeakeasyBase {
    /**
    ...
    @SpeakeasyMetadata()
    @Expose({ name: "unit" })
    unit: ClientFacingDistanceTimeseriesUnit;
